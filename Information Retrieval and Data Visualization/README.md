...
## Hybrid Recommender System for Movie Recommendation with Explicit Negative Feedback
...
## Software & Tools:
Python, Pandas, NumPy, SciPy, scikit-learn, implicit, SQLite
...
## Analysis of Drug Use and Fentanyl Enforcement
...
## Software & Tools:
Python, Pandas, NumPy, Matplotlib, Seaborn, GeoPandas, Jupyter Notebook; JSON/GeoJSON for geographic boundaries.
